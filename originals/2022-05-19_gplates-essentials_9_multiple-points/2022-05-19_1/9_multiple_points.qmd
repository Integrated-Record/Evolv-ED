...
Understanding how [individual points are reconstructed](singlepoint) is the basis for reconstructing more complicated data.
...
Let's open the PaleoMap rotation file and the corresponding polygons, as in the [previous tutorial](timerasters/#Other-tectonic-reconstructions):
...
Naturally, you could assign the IDs manually as in the [previous case](singlepoint), but that is not practical.
...
Now you should know everything to complete your [assignment](assignment/)!
